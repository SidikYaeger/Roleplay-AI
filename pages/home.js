...
const HomePage = (() => {
    ...
    const html = `
      <div class="page">
        ...
        <div class="settings-bar">
          <button class="btn btn-ghost btn-sm" onclick="HomePage.openSettings()" title="Pengaturan API">
  ...
  function openSettings() {
    App.openApiModal(true);
  }

  return { render, confirmDelete, openSettings, getAvatarHtml };
})();
